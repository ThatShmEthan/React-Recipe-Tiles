    ...
    <>
      ...
      <div id="main-container" className="extended-main-container">
        ...
        <div id="recipe-interface" className="half-block">
          ...
          <br />
          <button id="prep-timer" className="recipe-timer-button" style={{ float: 'left' }} onClick={() => setCookieTimer(recipeInfo.prepTime[0]*60*60 + recipeInfo.prepTime[1]*60)}>Start Prep
            Timer</button>
          <button id="cook-timer" className="recipe-timer-button" style={{ float: 'right' }} onClick={() => setCookieTimer(recipeInfo.cookTime[0]*60*60 + recipeInfo.cookTime[1]*60)}>Start Cook
            Timer</button>
          <br />
          ...
          <div className="recipe-interface-container">
            ...
            <div className="recipe-interface-box-medium" style={{ width: '80%', marginLeft: '10%' }}>{recipeInfo.description}
            </div>
          </div>
